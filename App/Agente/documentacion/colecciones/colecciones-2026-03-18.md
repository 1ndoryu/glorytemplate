...
- Los breadcrumbs de subcolección no deben depender de un fetch secuencial al padre; ese roundtrip retrasa la miga y se nota aunque el resto del header ya esté renderizado.
