...
const Campo = ({ etiqueta, valor, numerico, ancho }: {
    etiqueta: string;
    ...
    return (
        <div className={`inspectorCampo ${ancho ? 'inspectorCampoAncho' : ''}`}>
            ...
            <span className={`inspectorCampoValor ${numerico ? 'inspectorNumerico' : ''}`}>
                {valorTexto}
            </span>
        </div>
    );
...
export const ModalInspectorSample = ({
    abierto,
    onCerrar,
    sample,
}: ModalInspectorSampleProps): JSX.Element | null => {
            ...
            <div className="inspectorContenido">
                    ...
                    <div className="inspectorSeccion">
                        ...
                        <div className="inspectorTags">
                            {sample.tags.map((tag, i) => (
                                <span key={i} className="inspectorTag">{tag}</span>
                            ))}
                        </div>
                    </div>
                )}
                ...
                <div className="inspectorSeccion">
                    ...
                    <div className="inspectorGrid">
                        ...
                        {'totalReproducciones' in sample && (
                            <Campo etiqueta="Reproducciones" valor={(sample as Sample).totalReproducciones} numerico />
                        )}
                    </div>
                </div>
                    ...
                    <div className="inspectorSeccion">
                        ...
                        <div className="inspectorCreador">
                            <Avatar
                                ...
                                src={sample.creador.avatarUrl ?? undefined}
                                tamano="sm"
                            />
                            <div className="inspectorCreadorInfo">
                                <span className="inspectorCreadorNombre">
                                    ...
                                    {sample.creador.verificado && (
                                        <Badge variante="acento" tamano="xs">V</Badge>
                                    )}
                                </span>
                ...
                <div className="inspectorSeccion">
                    <button
                        ...
                        type="button"
                        style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px', background: 'none', border: 'none', padding: 0 }}
                    >
