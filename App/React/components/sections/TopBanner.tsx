...
export function TopBanner({text, linkText, linkHref}: TopBannerProps) {
    return (
        <div className="w-full py-2 px-6 relative text-xs font-mono border-b bg-secondary text-secondary border-secondary">
            <div className="mx-auto w-full max-w-7xl flex items-center justify-center gap-3">
                ...
                <a href={linkHref} className="font-semibold underline underline-offset-2 transition-colors flex items-center text-inherit hover:text-primary">
