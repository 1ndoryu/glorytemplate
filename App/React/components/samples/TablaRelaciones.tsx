...
import { Music, MoreVertical, Edit3, Trash2 } from 'lucide-react';
...
export const TablaRelaciones = ({ relaciones, direccion, marcarOrigen, onEditar, onEliminar }: TablaRelacionesProps): JSX.Element => {
