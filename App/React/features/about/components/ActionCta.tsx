...
export function ActionCta() {
    ...
    return (
        <section id="action-cta" className="mx-auto w-full max-w-3xl py-12">
            <a href={siteUrls.calendly} className="block relative rounded-2xl overflow-hidden h-64 md:h-80 group cursor-pointer transition-transform" aria-label={finalCta.title}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-8">
                    <h3 className="text-white text-2xl font-heading font-semibold mb-2">{finalCta.title}</h3>
