    ...
    return (
        <div id="settings-integrations-tab" className="settings-tab-content">
            ...
            <div className="settings-fields-grid">
                <SettingsField id="glory_gtm_id" label="Google Tag Manager ID" type="text" value={options.glory_gtm_id || ''} onChange={(value: string) => onUpdate('glory_gtm_id', value)} description="ID del contenedor GTM (ej: GTM-XXXXXXX). Se carga despues del consentimiento de cookies." placeholder="GTM-XXXXXXX" icon={<Tag className="settings-field-icon" />} />
