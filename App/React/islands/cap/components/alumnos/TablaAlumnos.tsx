 ...
 * Renderiza filas con acciones de editar/eliminar.
 */

import {useState} from 'react';
import {Input, Boton, Badge, Spinner} from '../ui';
import {IconoBuscar, IconoEditar, IconoEliminar, IconoOrdenar} from '../icons';
...
export function TablaAlumnos({alumnos, total, cargando, eliminando, filtros, onCambiarFiltros, onEditar, onEliminar}: TablaAlumnosProps) {
