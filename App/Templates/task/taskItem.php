...
{
    // ContentRender ya hace the_post(); $post está disponible pero aseguramos la variable global
    global $post;
    $filtro = 'tarea';

    echo '<div id="post-' . esc_attr($post->ID) . '" class="' . esc_attr($itemClass) . '">';
    // htmlTareas devuelve el <li> completo con la estructura usada por la lista
