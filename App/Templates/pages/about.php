...
function about_hero() {
    ...
    <section class="about-hero">
        <div class="hero-content">
            ...
            <h2 class="hero-subtitle-big">NOSOTROS</h2>
            <p class="hero-desc">
...
function about_method() {
    ...
    <section class="method-section">
        ...
        <h2 class="section-title">El Método COSMO</h2>
...
function about_bio() {
    ...
    <section class="bio-section">
        <div class="bio-content">
            <div class="bio-image">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=600&q=80" alt="Laura - Cosmo Revenue">
            </div>
            <div class="bio-text">
                <h2 class="bio-title">Hola, soy Laura</h2>
                <div class="bio-desc">
