...
DefaultContentManager::define('reserva', [
    [
        'slugDefault' => 'l-reserva-ejemplo-1',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-2',
        'titulo'      => 'Laura Gómez',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-06',
            'hora_reserva'     => '11:30',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-3',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-4',
        'titulo'      => 'Andrea Ruiz',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-07',
            'hora_reserva'     => '17:00',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-5',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-6',
        'titulo'      => 'María López',
        'metaEntrada' => [
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-7',
        'titulo'      => 'Jorge Pérez',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-08',
            'hora_reserva'     => '13:00',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-8',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-9',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-10',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-11',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-12',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-13',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-14',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-15',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-16',
        'titulo'      => 'Paula Méndez',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-12',
            'hora_reserva'     => '12:45',
    ...
    [
        'slugDefault' => 'l-reserva-ejemplo-17',
        'titulo'      => 'Alejandro Moreno',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-13',
            'hora_reserva'     => '09:15',
            'telefono_cliente' => '612334455',
            'correo_cliente'   => 'alejandro.moreno@email.com',
            'servicio'         => 'Corte de pelo',
            'barbero'          => 'Elkin',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-18',
        'titulo'      => 'Beatriz Salinas',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-13',
            'hora_reserva'     => '10:00',
            'telefono_cliente' => '623445566',
            'correo_cliente'   => 'beatriz.salinas@email.com',
            'servicio'         => 'Corte de pelo',
            'barbero'          => 'Juan',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-19',
        'titulo'      => 'Oscar Herrera',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-13',
            'hora_reserva'     => '11:30',
            'telefono_cliente' => '634556677',
            'correo_cliente'   => 'oscar.herrera@email.com',
            'servicio'         => 'Afeitado de barba',
            'barbero'          => 'Pedro',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-20',
        'titulo'      => 'Natalia Cruz',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-14',
            'hora_reserva'     => '12:00',
            'telefono_cliente' => '645667788',
            'correo_cliente'   => 'natalia.cruz@email.com',
            'servicio'         => 'Tinte de pelo',
            'barbero'          => 'Luis',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-21',
        'titulo'      => 'Hugo Álvarez',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-14',
            'hora_reserva'     => '14:00',
            'telefono_cliente' => '656778899',
            'correo_cliente'   => 'hugo.alvarez@email.com',
            'servicio'         => 'Corte de pelo',
            'barbero'          => 'Santiago',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-22',
        'titulo'      => 'Marta Peña',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-15',
            'hora_reserva'     => '09:45',
            'telefono_cliente' => '667889900',
            'correo_cliente'   => 'marta.pena@email.com',
            'servicio'         => 'Arreglo y perfilado de barba',
            'barbero'          => 'Elkin',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-23',
        'titulo'      => 'Iván Torres',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-15',
            'hora_reserva'     => '11:15',
            'telefono_cliente' => '678990011',
            'correo_cliente'   => 'ivan.torres@email.com',
            'servicio'         => 'Corte de pelo',
            'barbero'          => 'Juan',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-24',
        'titulo'      => 'Lucía Rivera',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-15',
            'hora_reserva'     => '13:30',
            'telefono_cliente' => '689001122',
            'correo_cliente'   => 'lucia.rivera@email.com',
            'servicio'         => 'Tinte de pelo',
            'barbero'          => 'Pedro',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-25',
        'titulo'      => 'Sergio Molina',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-16',
            'hora_reserva'     => '15:45',
            'telefono_cliente' => '690112233',
            'correo_cliente'   => 'sergio.molina@email.com',
            'servicio'         => 'Tinte de pelo',
            'barbero'          => 'Luis',
        ],
    ],
    [
        'slugDefault' => 'l-reserva-ejemplo-26',
        'titulo'      => 'Clara Peña',
        'metaEntrada' => [
            'fecha_reserva'    => '2025-08-16',
            'hora_reserva'     => '17:00',
            'telefono_cliente' => '601223344',
            'correo_cliente'   => 'clara.pena@email.com',
            'servicio'         => 'Lavar y peinar',
            'barbero'          => 'Santiago',
        ],
    ],
