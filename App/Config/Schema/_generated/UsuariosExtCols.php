...
final class UsuariosExtCols
{
    ...
    const TODAS = ['id', 'wp_user_id', 'username', 'email', 'nombre_visible', 'bio', 'avatar_url', 'portada_url', 'plan', 'rol', 'verificado', 'total_seguidores', 'total_seguidos', 'total_samples', 'total_descargas', 'stripe_customer_id', 'stripe_connect_id', 'created_at', 'updated_at', 'violaciones_moderacion', 'baneado_hasta', 'ban_razon', 'creditos_bonus', 'stripe_subscription_id', 'es_seed', 'sitio_web'];
}
