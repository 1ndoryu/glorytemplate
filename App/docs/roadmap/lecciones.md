...
- [tv_embedded como primario robusto]: `player_client=tv_embedded` pide el video como embed, bypasea algunas restricciones de canales oficiales sin necesitar PO tokens ni cookies. Mejor opción por default antes de intentar android_vr.
