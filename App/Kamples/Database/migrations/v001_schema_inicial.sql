/*
 * Kamples — Schema inicial de PostgreSQL
 * Migración v001: Tablas base del sistema
 *
 * Ejecutar manualmente en el VPS al configurar Postgres.
 * Requiere: PostgreSQL 15+ con extensión pgvector instalada.
 *
 * Comando: psql -U kamples -d kamples -f v001_schema_inicial.sql
 */
