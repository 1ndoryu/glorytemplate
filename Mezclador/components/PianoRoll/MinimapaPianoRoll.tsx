 ...
 * C310: Canvas que muestra una visión panorámica de las notas del canal.
 * Click = saltar a la posición. Drag = scroll rápido.
 * Dibuja un rectángulo de viewport para indicar la zona visible.
 */
...
export const MinimapaPianoRoll = memo(({
    ...
    const dibujar = useCallback(() => {
        ...
        if (anchoPixelTotal > 0 && altoPixelTotal > 0) {
            ...
            /* Ancho visible estimado: asumimos 800px visible */
